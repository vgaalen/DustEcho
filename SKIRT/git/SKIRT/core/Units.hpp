...
public:
    ...
    /** This function returns a string containing the name of the unit of time adopted by the
        program for output. */
    string utime() const;

    /** This function converts the time \f$t\f$ from the internally used SI units (s) to the
        program's output units. */
    double otime(double t) const;
