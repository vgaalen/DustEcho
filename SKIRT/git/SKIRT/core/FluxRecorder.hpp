...
public:
    ...
    /** This function configures the parameters for the lightcurve, which contains the time-dependence information of the SED*/
    void setLightcurveParameters(bool Active, int numBins, double Range);
