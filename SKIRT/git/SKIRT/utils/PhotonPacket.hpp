...
public:
    ...
    /** This function causes the propagation of the photon packet over a physical distance \f$s\f$.
        ...
        path. */
    void propagate(const PhotonPacket* pp, double s);
...
public:
    ...
    /** This function returns the distance this photon packet has traveled */
    double distance_traveled() const { return _D; }
...
private:
    ...
    double _D{0};      // current distance traveled
    //int lc_counter{0}; //count the amount of changes to _D
