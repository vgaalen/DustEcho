...
public:
    ...
    /** Returns whether the lightcurve function is active */
    int getLCActive() const {return _lcActive; }

    /** Returns the number of bins in the time range of the lightcurve */
    int getNumBins() const { return _numBins; }

    /** Returns the time range of the lightcurve in days */
    double getLCRange() const { return _lcRange; }
